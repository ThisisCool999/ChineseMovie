...
SC.patent={build(layer){
  layer.innerHTML='<div style="position:absolute;inset:0">'+svg("0 0 1600 900",
    ...
    '<g transform="translate(360,118)">'+
      ...
      '<text x="40" y="64" font-family="serif" font-size="40" fill="#2a2620" font-weight="700">调 查 报 告</text>'+
      '<line x1="40" y1="84" x2="832" y2="84" stroke="#9a8e74" stroke-width="2"/>'+
      '<text x="40" y="138" font-family="sans-serif" font-size="29" fill="#3a342a">提交：北蚕　　主题：阳光致死之成因</text>'+
      '<text x="40" y="200" font-family="sans-serif" font-size="27" fill="#3a342a">一、阳光中检出致死性「光毒」。</text>'+
      '<text x="40" y="248" font-family="sans-serif" font-size="27" fill="#3a342a">二、暴露者免疫系统清零，等同新生。</text>'+
      '<text x="40" y="296" font-family="sans-serif" font-size="27" fill="#3a342a">三、全球同步逆转，非自然成因——</text>'+
      '<g fill="#1a1712"><rect x="40" y="330" width="520" height="24"/><rect x="40" y="378" width="700" height="24"/><rect x="40" y="426" width="440" height="24"/><rect x="40" y="474" width="620" height="24"/></g>'+
      '<text x="40" y="616" font-family="monospace" font-size="22" fill="#6a6048">提交日期：灾难当年　·　状态：—</text>'+
      '<g id="stamp" transform="translate(620,548) rotate(-14)" opacity="0">'+
        '<rect x="-172" y="-60" width="344" height="120" rx="8" fill="none" stroke="#c0392b" stroke-width="6"/>'+
        '<rect x="-152" y="-42" width="304" height="84" rx="4" fill="none" stroke="#c0392b" stroke-width="2"/>'+
        '<text x="0" y="-8" text-anchor="middle" font-family="sans-serif" font-size="36" fill="#c0392b" font-weight="700">封 存</text>'+
        '<text x="0" y="36" text-anchor="middle" font-family="sans-serif" font-size="26" fill="#c0392b" font-weight="700">不 予 公 开</text>'+
      '</g>'+
    '</g>'+
  "")+'</div>';
  const stamp=layer.querySelector('#stamp');
  return{update(p){
    if(stamp){const k=clamp((p-.42)/.15,0,1);stamp.setAttribute('opacity',k.toFixed(2));
      stamp.setAttribute('transform','translate(620,548) rotate(-14) scale('+lerp(1.6,1,k).toFixed(3)+')');}
  }};
}};
...
{n:"镜38",frame:"中景",act:5,start:550,end:572,scene:"memo",fx:"none",
  subs:[S(2,9,"","一份调度令：『……编入户外作业梯队。』——他在『梯队』两个字上，停住了。","sfx"),
        S(10.5,18.5,"北蚕（画外音）","千分之三的人，晒了不会立刻死。他们就把这些人，赶去日光下，采矿、献血。","vo")]},
{n:"镜39",frame:"特写 · 文件",act:5,start:572,end:590,scene:"patent",fx:"none",
  subs:[S(2,8,"","他把一切，写成一份报告。三天后，报告被『封存』。","sfx"),
        S(9.5,16.5,"北蚕（画外音）","没有人，会相信一个说『阳光会杀人』的人。我能做的，只剩下一件事。","vo")]},
