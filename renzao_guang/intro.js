...
function handoff(reason){
  ...
  if(poster){
    ...
    [".poster-kicker",".poster-title",".poster-en",".poster-log",".start-btn",".poster-hint"].forEach(s=>
      poster.querySelectorAll(s).forEach(el=>{el.style.animation="none";void el.offsetWidth;el.style.animation="";}));
